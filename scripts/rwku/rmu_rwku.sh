...
echo "[rwku][RMU] Using base checkpoint ${base_model_path}"

experiment="unlearn/rwku/wga_lora.yaml"
trainer="RMU_lora"

output_root="${repo_root}/saves/unlearn/rwku/NEW_BUGFIX_rmu"
mkdir -p "${output_root}"
                ...
                for lora_r in "${lora_rs[@]}"; do
                    for lora_alpha in "${lora_alphas[@]}"; do
                        for lora_dropout in "${lora_dropouts[@]}"; do
                            ...
                            task_name=rwku_${base_model}_${forget_split}_rmu_lora_r${lora_r}_lalpha${lora_alpha}_ldrop${dropout_tag}_lr${lr}_sc${steering_tag}_alpha${alpha_tag}_gamma${gamma_tag}
